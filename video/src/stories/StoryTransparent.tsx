...
export const transparentSubtitles: Subtitle[] = [
    {
        leadingBlank: 1,
        duration: 3,
        text: 'The creators and trainers of Large-Scale Scrum have subtly updated the "Why LeSS?" article.',
        actions: [
            {
                actor: "slice",
                actionType: "scale",
