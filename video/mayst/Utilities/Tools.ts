...
export function getMinutesWithHours(hours: number, wild: boolean) {
    if (wild) {
        return hours * 60;
    }
    ...
    const time_struct = {
        ...
        6: [
            25, 5, 25, 10, 25, 5, 25, 5, 25, 20, 25, 5, 25, 10, 25, 5, 25, 10,
            25, 5, 25, 5,
        ],
        7: [
            25, 5, 25, 10, 25, 5, 25, 5, 25, 20, 25, 5, 25, 5, 25, 5, 25, 5, 25,
            10, 25, 5, 25, 5, 25, 10,
        ],
        8: [
            25, 5, 25, 10, 25, 5, 25, 20, 25, 5, 25, 10, 25, 5, 25, 20, 25, 5,
            25, 10, 25, 5, 25, 20, 25, 5, 25, 5,
        ],
    };
